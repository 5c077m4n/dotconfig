...
alias gshm='git show --show-signature origin/"$(gbdefault)"..'
...
alias gdm='git diff "$(gbdefault).."'
alias gdsm='git diff --staged  "$(gbdefault).."'
...
alias 'gco-'='git checkout -'
alias 'gco.'='git checkout .'
alias gupa='git pull --autostash --stat origin HEAD'
alias gprom='git pull --rebase --autostash --stat origin "$(gbdefault)"'
alias gprum='git pull --rebase --autostash --stat upstream "$(gbdefault)"'
alias ggpf='git push --force-with-lease origin HEAD'
...
alias glolm='git log --graph --pretty="%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%ar) %C(bold blue)<%an>%Creset" origin/"$(gbdefault)"..'
alias glols='git log --graph --pretty="%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%ar) %C(bold blue)<%an>%Creset" --stat'
alias glolsm='git log --graph --pretty="%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%ar) %C(bold blue)<%an>%Creset" --stat origin/"$(gbdefault)"..'
alias glola='git log --graph --pretty="%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%ar) %C(bold blue)<%an>%Creset" --all'
alias glolam='git log --graph --pretty="%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%ar) %C(bold blue)<%an>%Creset" --all origin/"$(gbdefault)"..'
