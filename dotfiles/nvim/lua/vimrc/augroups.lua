...
create_autocmd({ 'LspAttach' }, {
	...
	callback = function(args)
		...
		keymap.nnoremap('[e', function()
			diagnostic.goto_prev({ severity = vim.diagnostic.severity.ERROR, float = { border = 'single' } })
		end, { buffer = buffer_num, desc = 'Go to previous diagnostic error' })
		keymap.nnoremap(']e', function()
			diagnostic.goto_next({ severity = vim.diagnostic.severity.ERROR, float = { border = 'single' } })
