...
nnoremap(
	"]t",
	function() vscode.action("workbench.action.quickOpenNavigateNextInEditorPicker") end,
	{ desc = "Next tab" }
)
nnoremap(
	"[t",
	function() vscode.action("workbench.action.quickOpenNavigatePreviousInEditorPicker") end,
	{ desc = "Next tab" }
)
...
nnoremap(
	...
	{ desc = "Find current word in workspace" }
)
